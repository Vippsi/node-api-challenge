...
- [ ] Mention two parts of Express that you learned about this week.
  ...
  - I learned about express middleware and server-side routing

- [ ] Describe Middleware?

  - Middleware are functions that get ran in the order they're introduced into our code. They are able to intercept a request, preform some action, and then return a response

- [ ] Describe a Resource?

  - a resource is our different routes on the server ex: /api/posts vs /api/users
...
- [ ] How can we partition our application into sub-applications?
  ...
  - We can partition our application by splitting our routes for each resource into their own files, and just pull them into our server with server.use()
